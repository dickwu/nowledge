...
## Summary
Answer a question using retrieval results and the configured LLM provider when enabled.
...
flowchart TD
  ...
  n2["answer_rag_with_llm calls Store.answer_rag_async for grounded citations"]
