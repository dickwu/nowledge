...
| idempotency_key | string | optional | Batch-level key bound to the owner and full canonical batch; reuse with a different batch returns 409. |
...
Retrying the same owner-scoped batch `idempotency_key` reconciles unfinished
