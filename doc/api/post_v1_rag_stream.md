...
## Summary
Streaming-compatible alias that currently returns the same JSON response as /v1/rag/answer, using active fragment retrieval and provenance-rich citations.
